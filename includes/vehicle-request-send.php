...
try {
    ...
    $sub_total = $price_day * $days + array_sum(array_column($add_ons, 'cost'));
    $timestamp = time();
    ...
    // Send email to Admin
    $mail_res_admin = mail("tristanhughes719@gmail.com,info@keyscarrentalantigua.com,jc2o@mac.com,jrainey@tropicalstudios.com", $subject, $body, $headers);
