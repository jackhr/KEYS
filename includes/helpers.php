...
{
    $headers  = "From: bookings@keyscarrentalantigua.com\r\n";
...
function generateEmailBody($hotel, $first_name, $last_name, $country_region, $street, $town_city, $state_county, $phone, $email, $order_request_id, $vehicle, $add_ons, $itinerary, $days, $sub_total, $timestamp, $key, $vehicle_subtotal, $is_admin_email = false)
{
    ...
    if ($is_admin_email) {
        $intro = '<p style="margin:0 0 16px">Hi Tristan,</p>
                                                    ...
                                                    <tr>
                                                        <td valign="top" style="padding:48px 48px 32px">
                                                            <div style="color:#636363;' . $fontFamily . 'font-size:14px;line-height:150%;text-align:left">
                                                                ...
                                                                <p style="text-align:center;margin-bottom: 40px;"><strong>https://www.keyscarrentalantigua.com/confirmation/?key=' . $key . '</strong></p>
                                                                <p style="margin:0 0 16px;text-align: center;">Thanks for using <a href="https://www.keyscarrentalantigua.com/" target="_blank">www.keyscarrentalantigua.com</a>!</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
